...
const FAQ_DATA = [
    ...
    {
        category: 'general',
        question: "Qu'est-ce que Hinata ?",
        answer: "Hinata est une <strong>interface de discussion IA multi-modèles</strong> axée sur la confidentialité. Entièrement exécutée dans votre navigateur, elle fonctionne sans serveur distant. Vos conversations, réglages et clés API restent <strong>strictement locaux</strong> sur votre machine.<br><br>L'outil vous permet d'interroger les meilleures IA du marché (OpenAI, Anthropic, Google, Mistral, modèles locaux, etc.) depuis une interface unifiée. Il utilise vos propres clés API, que vous pouvez facilement configurer grâce aux boutons de redirection présents dans les paramètres de l'application."
    },
    {
        category: 'general',
        question: "Mes données sont-elles en sécurité ?",
        answer: "<strong>Oui, totalement.</strong> Toutes vos conversations, agents et prompts sont stockés <strong>uniquement dans votre navigateur</strong> (IndexedDB et localStorage).<br><br>Aucune donnée ne transite par nos serveurs. Les requêtes sont envoyées <strong>directement</strong> depuis votre navigateur vers les fournisseurs d'IA (OpenAI, Anthropic, etc.) grâce à vos propres clés API.<br><br><strong>Important :</strong> pour garantir cette sécurité, Kiro doit être utilisé sur un <strong>ordinateur personnel non accessible au public</strong>. Ne l'installez jamais sur un hébergement en ligne (mutualisé, VPS, etc.) : dans ce cas, vos données et vos clés API seraient exposées et insuffisamment protégées."
    },
    {
        category: 'general',
        question: "Comment le coût de mes conversations est-il calculé ?",
        answer: "Les fournisseurs d'IA facturent à l'usage basé sur les <strong>tokens</strong> (1 token représente environ 3/4 d'un mot). Chaque modèle applique un tarif spécifique pour les tokens lus en entrée (votre prompt) et les tokens générés en sortie (la réponse de l'IA).<br><br>Kiro calcule ces coûts <strong>en temps réel</strong> en multipliant le nombre de tokens consommés par les tarifs officiels au million de tokens de chaque modèle. Ce calcul vous est fourni à titre indicatif pour vous aider à suivre votre budget, le prélèvement réel étant effectué directement sur le compte de votre fournisseur d'API.<br><br><strong>Cas particulier d'OpenRouter :</strong> pour les modèles utilisés via OpenRouter, le coût affiché par Kiro <strong>n'est pas une estimation</strong> mais le <strong>coût réel facturé</strong>, retourné par l'API d'OpenRouter à chaque échange. Vous bénéficiez donc d'une précision parfaite, marge incluse, sans écart possible avec votre solde OpenRouter."
    },
    {
        category: 'general',
        question: "Qu'est-ce qu'un prompt ?",
        answer: "Un prompt est le <strong>message que vous envoyez à l'IA</strong> : votre question, votre demande ou votre instruction. C'est à partir de ce texte que l'IA génère sa réponse. Plus votre prompt est précis et détaillé, plus la réponse sera pertinente.<br><br><strong>Exemple :</strong> « Rédige un e-mail professionnel pour refuser poliment une invitation à un séminaire, en remerciant l'organisateur et en proposant de rester informé des prochaines éditions. »<br><br>Dans Kiro, vous tapez votre prompt dans le champ de saisie en bas de l'écran. Le <strong>bouton dédié dans la barre de saisie</strong> vous permet d'insérer rapidement un prompt enregistré. Pour <strong>créer, modifier ou supprimer</strong> vos prompts enregistrés, cliquez sur le bouton <strong>« Prompts »</strong> du menu de gauche."
    },
    {
        category: 'general',
        question: "Qu'est-ce qu'un agent ?",
        answer: "Un agent (aussi appelé <em>system prompt</em>) est une <strong>instruction de fond</strong> que vous donnez à l'IA avant même de commencer à lui parler. Elle s'applique à <strong>toute la conversation</strong> et conditionne la façon dont l'IA va se comporter, répondre et se présenter. L'agent est <strong>facultatif</strong> : sans agent, l'IA répond de façon généraliste.<br><br>Concrètement, un agent permet de dire à l'IA : <em>« Tu es X, tu fais Y, tu t'exprimes de telle façon »</em>. Cela évite de répéter ce contexte à chaque message.<br><br>Pour définir l'agent d'une conversation, ouvrez le <strong>volet de droite</strong> en cliquant sur l'icône ⚙ située à droite de la zone de saisie. Vous pouvez y saisir un agent manuellement ou en sélectionner un parmi vos agents enregistrés."
    },
    {
        category: 'general',
        question: "Quelle différence entre un prompt et un agent ?",
    ...
    {
        category: 'learn',
        question: "Quels types de fichiers puis-je analyser avec Kiro ?",
    ...
    },
    {
        ...
        answer: "Pour toute question ou suggestion, contactez <a href=\"mailto:contact@eliesept.com\">Sept Ngiene</a> à l'adresse contact@eliesept.com."
    }
];

FAQ_DATA.forEach(item => {
    item.question = item.question.replaceAll('Kiro', 'Hinata');
    item.answer = item.answer.replaceAll('Kiro', 'Hinata');
});